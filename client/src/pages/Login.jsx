      ...
      <div className='w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center'>
        <div className='h-full w-full lg:w-2/3 flex flex-col items-center justify-center'>
          <div className='w-full md:max-w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5 md:gap-y-10 2xl:-mt-20'>
            ...
            <p className='flex flex-col gap-1 md:gap-2 text-2xl md:text-4xl 2xl:text-5xl font-extrabold text-center dark:text-gray-400 text-blue-700 leading-tight'>
            <span className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-indigo-600 drop-shadow-md tracking-wide font-[Poppins]">
  Spact
</span>

<span className="text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-amber-500 drop-shadow-md tracking-wide font-[Poppins]">
  One Space for Every Task
</span>
