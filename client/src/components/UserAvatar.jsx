...
const UserAvatar = () => {
    ...
    <>
      ...
      {showConfirmLogout && (
        <div className='fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center'>
          <div className='bg-white dark:bg-[#2c2c2c] p-6 rounded-xl shadow-xl text-center w-[90%] max-w-sm'>
  ...
  <button
    ...
    className="min-w-[100px] px-4 py-2 bg-red-600 text-white rounded-md font-medium hover:bg-red-700 transition"
  >
    OK
  </button>
  <button
    onClick={() => setShowConfirmLogout(false)}
    className="min-w-[100px] px-4 py-2 bg-gray-300 dark:bg-gray-700 text-black dark:text-white rounded-md font-medium hover:bg-gray-400 dark:hover:bg-gray-600 transition"
  >
    Cancel
  </button>
</div>
