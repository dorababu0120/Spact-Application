      ...
      <div className='w-full min-h-screen bg-[#f3f4f6] dark:bg-[#0d0d0df4]'>
        <Routes>
          <Route element={<Layout />}>
            {/* FIXED typo: changed 'psth' to 'path' and removed path since index doesn't need it */}
            ...
            {/* Your new personal-task route */}
            <Route path="/personal-task" element={<PersonalTaskList />} />
          </Route>
